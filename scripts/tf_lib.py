...
def tf_unit(u, n_cells, t_vals, K, M, C=0):
    mid_n = int(len(M) / 2)
    M21 = M[mid_n:, :mid_n]
    K21 = K[mid_n:, :mid_n]
    ...
    # t_vals = np.linspace(0.01, 1, 100)  # Define time range

    # n_cells is number of cells
...
if __name__ == "__main__":
    ...
    v = tf_unit(u0 / 100, 1, t_vals, truss.K, truss.M)
